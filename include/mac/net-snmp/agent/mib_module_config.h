...
/* Define if compiling with the mibII/data_access/at_sysctl module files.  */
#define USING_MIBII_DATA_ACCESS_AT_SYSCTL_MODULE 1
...
/* Define if compiling with the mibII/kernel_sysctl module files.  */
#define USING_MIBII_KERNEL_SYSCTL_MODULE 1
...
/* Define if compiling with the hardware/fsys/fsys_getfsstats module files.  */
#define USING_HARDWARE_FSYS_FSYS_GETFSSTATS_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/arp_sysctl module files.  */
#define USING_IP_MIB_DATA_ACCESS_ARP_SYSCTL_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/systemstats_sysctl module files.  */
#define USING_IP_MIB_DATA_ACCESS_SYSTEMSTATS_SYSCTL_MODULE 1
 
/* Define if compiling with the ip-mib/data_access/scalars_sysctl module files.  */
#define USING_IP_MIB_DATA_ACCESS_SCALARS_SYSCTL_MODULE 1
...
/* Define if compiling with the tcp-mib/data_access/tcpConn_freebsd4 module files.  */
#define USING_TCP_MIB_DATA_ACCESS_TCPCONN_FREEBSD4_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/ipaddress_sysctl module files.  */
#define USING_IP_MIB_DATA_ACCESS_IPADDRESS_SYSCTL_MODULE 1
...
/* Define if compiling with the ip-mib/data_access/defaultrouter_sysctl module files.  */
#define USING_IP_MIB_DATA_ACCESS_DEFAULTROUTER_SYSCTL_MODULE 1
...
/* Define if compiling with the ip-forward-mib/data_access/route_sysctl module files.  */
#define USING_IP_FORWARD_MIB_DATA_ACCESS_ROUTE_SYSCTL_MODULE 1
...
/* Define if compiling with the udp-mib/data_access/udp_endpoint_freebsd4 module files.  */
#define USING_UDP_MIB_DATA_ACCESS_UDP_ENDPOINT_FREEBSD4_MODULE 1
