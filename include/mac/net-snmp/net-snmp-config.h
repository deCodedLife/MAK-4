...
/* Define if __u8 .. __u64 must be declared explicitly before including
   <linux/ethtool.h> */
#define HAVE_LINUX_ETHTOOL_NEEDS_U64 1
...
#define HAVE_OPENSSL_SK_NUM 1

/* Define to 1 if you have the `OPENSSL_sk_value' function. */
#define HAVE_OPENSSL_SK_VALUE 1
...
#define NETSNMP_CONFIGURE_OPTIONS " '--disable-debugging' '--prefix=/opt/homebrew/Cellar/net-snmp/5.9.4' '--enable-ipv6' '--with-defaults' '--with-persistent-directory=/opt/homebrew/var/db/net-snmp' '--with-logfile=/opt/homebrew/var/log/snmpd.log' '--with-mib-modules=host ucd-snmp/diskio' '--without-rpm' '--without-kmem-usage' '--disable-embedded-perl' '--without-perl-modules' '--with-openssl=/opt/homebrew/opt/openssl@3' 'CC=clang' 'PKG_CONFIG_PATH=/opt/homebrew/opt/openssl@3/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/14'"
...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/opt/homebrew/Cellar/net-snmp/5.9.4/share/snmp/mibs"
...
#define NETSNMP_FD_MASK_TYPE __int32_t
...
#define NETSNMP_IOCTLSOCKET_ARG unknown
...
#define PACKAGE_STRING "Net-SNMP 5.9.4.pre2"
#endif
...
#define PACKAGE_VERSION "5.9.4.pre2"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:HOST-RESOURCES-TYPES:UCD-DISKIO-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-PASS-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/opt/homebrew/var/db/net-snmp"
...
#define SNMPLIBPATH "/opt/homebrew/Cellar/net-snmp/5.9.4/lib/snmp"
#define SNMPSHAREPATH "/opt/homebrew/Cellar/net-snmp/5.9.4/share/snmp"
#define SNMPCONFPATH "/opt/homebrew/Cellar/net-snmp/5.9.4/etc/snmp"
#define SNMPDLMODPATH "/opt/homebrew/Cellar/net-snmp/5.9.4/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/opt/homebrew/var/log/snmpd.log"
...
#define DRAGONFLYID   NETSNMP_DRAGONFLYID
